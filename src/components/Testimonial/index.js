          ...
          <React.Fragment>
            <main className="row">
              <section className="col-sm">
                ...
                <h3 className={styles["testimony-name"]}>
                  {nameTesti !== null ? nameTesti : "users"}
                </h3>
              </section>
              ...
              <section className="col-sm">
                <div className={styles["ring-gradient-profile"]}>
                  ...
                  <div>
                    <div
                      style={{ backgroundImage: `url(${profileImgDefault})` }}
                      className={styles["testimony-img-default"]}
                    >
