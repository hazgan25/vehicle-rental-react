        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route element={<PrivateRoutes />}>
              ...
              <Route
                path={`reservation/vehicle=:id&quantity=:quantity`}
                element={<Reservation />}
              />
              <Route
                path={`payment/vehicle=:id&quantity=:quantity&day=:day&price%20perday=:priceDay&totalPrice=:total`}
                element={<Payment />}
              />
            </Route>
            ...
            <Route element={<PrivateRoutes />}>
              <Route element={<OwnerRoutes />}>
                ...
                <Route
                  path="history%20renter"
                  element={<HistoryOrderRenter />}
                />
              </Route>
            </Route>
