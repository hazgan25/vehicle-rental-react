...
const VehicleDetail = () => {
  ...
  const reservationHandler = () => {
    if (stockReservation > dataVehicle.stock) {
      ...
      navigate(
        `/reservation/vehicle=${dataVehicle.id}&quantity=${stockReservation}`
      );
    }
    if (!token) {
      Swal.fire({
      ...
      <main className="container mt-3 mb-3">
        ...
        >
          ...
          <h3 className={styles["item-text"]}>
            {dataVehicle.owner_id === userData.id ? "Edit Item" : "Detail"}
          </h3>
        </section>
        ...
        {token && dataVehicle.owner_id === userData.id ? (
            ...
            <section className={`mt-5 ${styles["flex-main"]}`}>
              <div className={styles["edit-left"]}>
                ...
                >
                  ...
                  <img
                    src={
                      isEditImg1 === false
                        ? `${process.env.REACT_APP_HOST}/${dataVehicle.images[0].images}`
                        : showImg1
                    }
                  ...
                  {dataVehicle.images[1] !== undefined ? (
                    ...
                    >
                      ...
                      <img
                        src={
                          isEditImg2 === false
                            ? `${process.env.REACT_APP_HOST}/${dataVehicle.images[1].images}`
                            : showImg2
                        }
                        onError={({ currentTarget }) => {
                          currentTarget.onerror = null;
                  ...
                  {dataVehicle.images[2] !== undefined ? (
                    ...
                    >
                      ...
                      <img
                        src={
                          isEditImg3 === false
                            ? `${process.env.REACT_APP_HOST}/${dataVehicle.images[2].images}`
                            : showImg3
                        }
                        onError={({ currentTarget }) => {
                          currentTarget.onerror = null;
              ...
              <div className={styles["edit-right"]}>
                <input
                  ...
                  placeholder="Type the Name Vehicle"
                  value={vehicleName}
          ...
          <React.Fragment>
            <section className={`mt-5 ${styles["flex-main"]}`}>
              ...
              <div className={styles["edit-right"]}>
                <h2 className={styles["vehicle-text"]}>
                  {dataVehicle.vehicle}
                </h2>
                <p className={styles["location-text"]}>
                  {dataVehicle.location}
                </p>
                <p
                ...
                >
                  {dataVehicle.stock === 0 ? "Non Available" : "Available"}
                </p>
                <p
                  className={styles["fourty-four-size"]}
                  style={{ color: "red" }}
                ...
                <p className={`text-secondary ${styles["fourty-four-size"]}`}>
                  Capacity :{" "}
                  {dataVehicle.types_id === 1
                    ? "4"
                    : dataVehicle.types_id === 2
                    ? "2"
                    : "1"}{" "}
                  person
                </p>
                ...
                >{`Rp. ${formatRupiah(vehiclePriceReservation)}/day`}</h3>
                <div
                  className="mt-5"
