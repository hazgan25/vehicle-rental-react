            ...
            <div className={`container-fluid ${styles['transparan-bg']}`}>
                <div className='container'>
                    <div className={styles['err-page']}>
                        ...
                        <h3 className={styles['error-server-text']}>looks like the server has an error/Maintenance</h3>
                        ...
                        <ul>
                            ...
                            <li className={styles['err-about-text']}>
                                ...
                                <a href="https://devcenter.heroku.com/articles/free-dyno-hours" className={styles['orange-text']} target="_blank" rel="noopener noreferrer"> Offical Dyno Hour Heroku </a>
