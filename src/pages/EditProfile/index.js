  ...
  const editPasswordHandler = () => {
    ...
    if (curPass !== "" && newPass !== "" && rePass !== "") {
      ...
      editPasswordUser(body, token)
        .then((res) => {
          Swal.fire(`${res.data.result.msg}`, "Please Login Again!", "success");
          setIsModal(false);
          setCurrPass("");
          setNewPass("");
          setRePass("");
        ...
        <section className={styles["profile-edit"]}>
          ...
          <div className={styles["user-data"]}>
            <h1 className={styles["user-name"]}>
              {name === null || name === "" ? "No Name" : name}
            </h1>
            <p className={styles["info-data"]}>{email}</p>
            <p className={styles["info-data"]}>
              {phone === null || phone === "" ? "No Phone" : phone}
            </p>
            <p
              className={styles["info-data"]}
            >{`Has been active since ${active_year}`}</p>
          </div>
        </section>
        ...
        <section style={{ position: "relative", top: 154 }}>
          <section className="container">
            <div className={styles["contacts-edit"]}>
              ...
              <input
                type={"email"}
                className={styles["input-contacts"]}
                value={userEmail}
                onChange={(e) => setUserEmail(e.target.value)}
              />
              <label className={styles["label"]} style={{ marginTop: 53 }}>
                Address :{" "}
              </label>
              <input
                type={"text"}
            ...
            <div className={styles["contacts-edit"]} style={{ marginTop: 53 }}>
              ...
              <div className={styles["identity-edit"]}>
                ...
                <input
                  type={"text"}
                  className={styles["input-identity"]}
                  value={userName}
              ...
              <div className={styles["select-button"]}>
                ...
                <button
                  className={styles["btn-edit-password"]}
          ...
          >
            ...
            <Modal.Footer>
              <Button className="btn-secondary" onClick={cancelPassHandler}>
                Cancel
              </Button>
              <Button className="btn-warning" onClick={editPasswordHandler}>
                Confirm
              </Button>
            </Modal.Footer>
          </Modal>
