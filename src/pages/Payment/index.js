      ...
      <main className="container mt-3 mb-3">
        ...
        <section className={`mt-4 ${styles["flex-one"]}`}>
          <div className={`${styles["left"]} ${styles["box-text"]}`}>
            ...
            >{`Quantity : ${quantity} ${vehicleData.types}`}</p>
          </div>
          <div
        ...
        <section className={`mt-4 ${styles["flex-one"]}`}>
          <div className={`${styles["left"]} ${styles["box-text"]}`}>
            ...
            <p className={styles["box-normal-text"]}>{`${quantity} ${
              vehicleData.types
            } : Rp.${formatRupiah(vehicleData.price * parseInt(quantity))}`}</p>
            <p
              className={styles["box-normal-text"]}
            >{`during ${day} day : Rp.${formatRupiah(
              vehicleData.price * parseInt(day)
            )}`}</p>
            <p className={styles["box-text-bold"]}>
              Total :
              <span className={styles["box-normal-text"]}>{` Rp.${formatRupiah(
                total
              )}`}</span>
            </p>
          </div>
